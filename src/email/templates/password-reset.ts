...
export function renderPasswordReset(opts: { appName: string; url: string; userName?: string }): string {
  ...
  const content = `
    ...
    <p style="font-size:15px; color:#536471; line-height:1.6; margin:0 0 4px;">We received a request to reset your password for your ${opts.appName} account. Click the button below to choose a new password.</p>
